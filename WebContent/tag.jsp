			...
			<div class="col-md-3" id="left_content">
				...
				<div id="list">
					<table class="table table-hover c_center">
						...
						<tr>
							<td class="active"><a href="pageContext.request.contextPath}/tag"><span class="glyphicon glyphicon-tags"></span>
								&nbsp;&nbsp;所有标签</a></td>
						</tr>						
						<tr>
			...
			<div class="col-md-7 " id="right_content">
				...
				<div class="list-group">
					...
					<c:forEach items="${tags}" var="tag">					
						<div class="tags_name">
						<!-- 标签名字 -->
						<a href="${pageContext.request.contextPath}/blogsByTag?tagName=${tag.tagName}"><span class="glyphicon glyphicon-triangle-bottom"></span>${tag.tagName}</a>	
						</div>
					</c:forEach>							
